 ...
 */
//@MapperScan(basePackages = {"com.taotao.cloud.message.infrastructure.persistent.*.mapper"})
//@EnableJpaRepositories(
//	basePackages = {"com.taotao.cloud.message.infrastructure.persistent.*.repository.inf"},
//	repositoryFactoryBeanClass = JpaExtendRepositoryFactoryBean.class)
//@ComponentScan(basePackages = {
//	"com.taotao.cloud.message.biz.repository.cls"
//} )
//@EnableFeignClients(basePackages = {"com.taotao.cloud.message.api.feign","com.taotao.cloud.message.api.feign"})
