...
public class RecipientHandler {
	...
	private final Map<Integer, com.taotao.cloud.sys.infrastructure.channels.websockt.spring.recipient.RecipientFilter> recipientFilterMap = new LinkedHashMap<>();

	public RecipientHandler(List<com.taotao.cloud.sys.infrastructure.channels.websockt.spring.recipient.RecipientFilter> recipientFilterList) {
		for (com.taotao.cloud.sys.infrastructure.channels.websockt.spring.recipient.RecipientFilter recipientFilter : recipientFilterList) {
	...
	public List<SysUser> query(Integer filterType, List<Object> filterCondition) {
		com.taotao.cloud.sys.infrastructure.channels.websockt.spring.recipient.RecipientFilter recipientFilter = recipientFilterMap.get(filterType);
	...
	public boolean match(Integer recipientFilterType, Object filterAttr, List<Object> recipientFilterCondition) {
		com.taotao.cloud.sys.infrastructure.channels.websockt.spring.recipient.RecipientFilter recipientFilter = recipientFilterMap.get(recipientFilterType);
