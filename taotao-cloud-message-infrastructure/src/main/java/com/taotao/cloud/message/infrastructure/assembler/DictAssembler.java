...
import com.taotao.cloud.message.api.client.response.DictApiResponse;
import com.taotao.cloud.message.infrastructure.persistent.persistence.dict.DictPO;
...
public interface DictAssembler {
    ...
    // * @return com.taotao.cloud.message.biz.entity.SysDict
    ...
    // * @return java.util.List<com.taotao.cloud.message.api.vo.user.UserVO>
    //
    ...
    // * @return com.taotao.cloud.message.api.vo.user.UserVO
    //
