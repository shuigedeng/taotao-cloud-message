...
public class NotifyPushExecutor {
	...
	private final Map<Integer, com.taotao.cloud.sys.infrastructure.channels.websockt.spring.push.NotifyPusher> notifyPusherMap = new LinkedHashMap<>();

	public NotifyPushExecutor(RecipientHandler recipientHandler, List<com.taotao.cloud.sys.infrastructure.channels.websockt.spring.push.NotifyPusher> notifyPusherList) {
		this.recipientHandler = recipientHandler;
		if (CollUtil.isNotEmpty(notifyPusherList)) {
			for (com.taotao.cloud.sys.infrastructure.channels.websockt.spring.push.NotifyPusher notifyPusher : notifyPusherList) {
	 ...
	 */
	public void addNotifyPusher(com.taotao.cloud.sys.infrastructure.channels.websockt.spring.push.NotifyPusher notifyPusher) {
